Doorkeeper.configure do
  ...
  # to set up new applications
  # https://dev.chiirp.com/oauth/applications
  # https://app.chiirp.com/oauth/applications

  # to log in
  # https://dev.chiirp.com/oauth/authorize?client_id=xxx&redirect_uri=xxx&response_type=code&state=xxx
  ...
  resource_owner_authenticator do |_routes|
    if user_signed_in?
      ...
      session[:previous_url] = request.fullpath unless %r{/users}.match?(request.fullpath)
  ...
  skip_authorization do |_resource_owner, client|
    # skip authorizaiton for the client with id 13
    client.id == 13
  end
