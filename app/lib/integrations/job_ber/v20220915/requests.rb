...
# app/lib/integrations/job_ber/v20220915/requests.rb
module Integrations
  module JobBer
    module V20220915
      module Requests
        ...
        def request(jobber_request_id = nil)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20220915::Requests.request',
            method:                'post',
            params:                nil,
        ...
        def requests(jobber_client_id = nil)
          ...
          loop do
            ...
            jobber_request(
              body:,
              error_message_prepend: 'Integrations::JobBer::V20220915::Requests.requests',
              method:                'post',
              params:                nil,
              default_result:        @result,
              url:                   api_url
