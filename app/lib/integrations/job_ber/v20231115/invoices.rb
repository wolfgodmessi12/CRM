...
# app/lib/integrations/job_ber/v20231115/invoices.rb
module Integrations
  module JobBer
    module V20231115
      module Invoices
        ...
        def invoice(jobber_invoice_id = nil)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Invoices.invoice',
            method:                'post',
            params:                nil,
        ...
        def invoices(jobber_client_id = nil)
          ...
          loop do
            ...
            jobber_request(
              body:,
              error_message_prepend: 'Integrations::JobBer::V20231115::Invoices.invoices',
              method:                'post',
              params:                nil,
              default_result:        @result,
              url:                   api_url
