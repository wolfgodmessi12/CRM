    ...
    module V20231115
      module Clients
        ...
        def client(jobber_client_id)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Clients.client',
            method:                'post',
            params:                nil,
        ...
        def client_create(contact)
              ...
              mutation {
                clientCreate(
                  input: {
                    ...
                    billingAddress: {
                      street1: "#{contact.dig(:address1)}",
                      street2: "#{contact.dig(:address2)}",
                      city: "#{contact.dig(:city)}",
                      province: "#{contact.dig(:state)}",
                      postalCode: "#{contact.dig(:zip)}",
                    },
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Clients.client_create',
            method:                'post',
            params:                nil,
            default_result:        @result,
            url:                   api_url
        ...
        def client_update(jobber_client_id, contact)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Clients.client_update',
            method:                'post',
            params:                nil,
            default_result:        @result,
            url:                   api_url
        ...
        def clients(args = {})
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Clients.clients',
            method:                'post',
            params:                nil,
            default_result:        @result,
            url:                   api_url
