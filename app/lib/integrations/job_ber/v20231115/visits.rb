...
# app/lib/integrations/job_ber/v20231115/visits.rb
module Integrations
  module JobBer
    module V20231115
      module Visits
        ...
        def visit(jobber_visit_id = nil)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Visits.visit',
            method:                'post',
            params:                nil,
        ...
        def visits(jobber_job_id)
          ...
          loop do
            ...
            jobber_request(
              body:,
              error_message_prepend: 'Integrations::JobBer::V20231115::Visits.visits',
              method:                'post',
              params:                nil,
              default_result:        @result,
              url:                   api_url
