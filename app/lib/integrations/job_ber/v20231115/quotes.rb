...
# app/lib/integrations/job_ber/v20231115/quotes.rb
module Integrations
  module JobBer
    module V20231115
      module Quotes
        ...
        def quote(jobber_quote_id = nil)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Quotes.quote',
            method:                'post',
            params:                nil,
        ...
        def quotes(jobber_client_id = nil)
          ...
          loop do
            ...
            jobber_request(
              body:,
              error_message_prepend: 'Integrations::JobBer::V20231115::Quotes.quotes',
              method:                'post',
              params:                nil,
              default_result:        @result,
              url:                   api_url
