...
# app/lib/integrations/job_ber/v20231115/users.rb
module Integrations
  module JobBer
    module V20231115
      module Users
        ...
        def user(jobber_user_id = nil)
          ...
          jobber_request(
            body:,
            error_message_prepend: 'Integrations::JobBer::V20231115::Users.user',
            method:                'post',
            params:                nil,
        ...
        def users
          ...
          loop do
            ...
            jobber_request(
              body:,
              error_message_prepend: 'Integrations::JobBer::V20231115::Users.users',
              method:                'post',
              params:                nil,
              default_result:        @result,
              url:                   api_url
