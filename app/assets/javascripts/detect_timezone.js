...
jstz.convert_tz_to_rails = function(jstz_olson_timezone) {
  for (var key in MAPPING) {
    if (MAPPING[key] === jstz_olson_timezone) return key;
  }
};

jstz.convert_tz_from_rails = function(rails_timezone) {
  return MAPPING[rails_timezone];
};
...
jstz.olson.timezones = {
    ...
    '-420,0'   : new jstz.TimeZone('-07:00', 'America/Arizona', false),
    '-420,1'   : new jstz.TimeZone('-07:00', 'America/Boise', true),
