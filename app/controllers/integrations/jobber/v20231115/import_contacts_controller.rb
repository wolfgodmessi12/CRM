...
# app/controllers/integrations/jobber/v20231115/import_contacts_controller.rb
module Integrations
  module Jobber
    module V20231115
      class ImportContactsController < Jobber::IntegrationsController
        # (GET) show import contacts screen
        # /integrations/jobber/v20231115/import_contacts
        # integrations_jobber_v20231115_import_contacts_path
        # integrations_jobber_v20231115_import_contacts_url
        def show
          render partial: 'integrations/jobber/v20231115/js/show', locals: { cards: %w[show_import_contacts] }
        end
        ...
        def update
          ...
          Integrations::Jobber::V20231115::Imports::ContactsJob.perform_later(
