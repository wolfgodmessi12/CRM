...
# app/controllers/integrations/jobber/v20231115/webhooks_controller.rb
module Integrations
  module Jobber
    module V20231115
      # support for configuring actions on incoming webhooks from Jobber
      class WebhooksController < Jobber::IntegrationsController
        # (POST)
        # /integrations/jobber/v20231115/webhooks
        # new_integrations_jobber_v20231115_webhook_path
        # new_integrations_jobber_v20231115_webhook_url
        def create
          create_new_webhook

          render partial: 'integrations/jobber/v20231115/js/show', locals: { cards: %w[webhooks_index] }
        end

        # (DELETE)
        # /integrations/jobber/v20231115/webhooks/:id
        # integrations_jobber_v20231115_webhooks_path(:id)
        # integrations_jobber_v20231115_webhooks_url(:id)
        def destroy
          destroy_webhook
        ...
        # (GET)
        # /integrations/jobber/v20231115/webhooks/:id/edit
        # edit_integrations_jobber_v20231115_webhook_path(:id)
        # edit_integrations_jobber_v20231115_webhook_url(:id)
        def edit
          @webhook = find_webhook_by_id(params.permit(:id).dig(:id))

          render partial: 'integrations/jobber/v20231115/js/show', locals: { cards: %w[webhooks_edit] }
        end

        # (GET)
        # /integrations/jobber/v20231115/webhooks
        # integrations_jobber_v20231115_webhooks_path
        # integrations_jobber_v20231115_webhooks_url
        def index
          render partial: 'integrations/jobber/v20231115/js/show', locals: { cards: %w[webhooks_index] }
        end

        # (GET)
        # /integrations/jobber/v20231115/webhooks/new
        # new_integrations_jobber_v20231115_webhooks_path
        # new_integrations_jobber_v20231115_webhooks_url
        def new
          ...
          render partial: 'integrations/jobber/v20231115/js/show', locals: { cards: %w[webhooks_index webhooks_open_new] }
        end

        # (PATCH/PUT) update webhooks
        # /integrations/jobber/v20231115/webhooks/:id
        # integrations_jobber_v20231115_webhook_path(:id)
        # integrations_jobber_v20231115_webhook_url(:id)
        def update
          destroy_webhook
          create_new_webhook
