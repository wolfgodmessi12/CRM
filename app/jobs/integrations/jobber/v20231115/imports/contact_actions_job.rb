...
# app/jobs/integrations/jobber/v20231115/imports/contact_actions_job.rb
module Integrations
  module Jobber
    module V20231115
      module Imports
        class ContactActionsJob < ApplicationJob
          ...
          # Integrations::Jobber::V20231115::Imports::ContactActionsJob.set(wait_until: 1.day.from_now).perform_later()
          # Integrations::Jobber::V20231115::Imports::ContactActionsJob.set(wait_until: 1.day.from_now, priority: 0).perform_later(
          def initialize(**args)
            super
          ...
          def perform(**args)
            ...
            return unless Integer(args.dig(:client_id), exception: false).present? && Integer(args.dig(:user_id), exception: false).present? &&
                          args.dig(:actions).is_a?(Hash) && args.dig(:account_balance).is_a?(BigDecimal) &&
