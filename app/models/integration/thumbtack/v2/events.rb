...
# app/models/integration/thumbtack/v2/events.rb
module Integration
  module Thumbtack
    module V2
      module Events
        ...
        #   (req) params:  (Hash) JSON body from Thumbtail API - https://api.thumbtack.com/docs/#leads
        def process_lead_event(params:)
          ...
          @client_api_integration.events.each do |event|
            ...
            contact.raw_posts.create(ext_source: 'thumbtack', ext_id: params.dig(:customer, :customerID), data: params)
            ...
            ext_ref = contact.ext_references.find_or_initialize_by(target: 'thumbtack', ext_id: params.dig(:customer, :customerID))
